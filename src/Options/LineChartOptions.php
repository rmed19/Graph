...
/**
 * File containing the LineChartOption class
 *
 ...
 * are using:
 *
 * - Ezc\Graph\Options\RendererOptions
 ...
 * @property FontOptions $highlightFont
...
class LineChartOptions extends ChartOptions
{
    ...
    public function __construct( array $options = array() )
    {
        ...
        $this->properties['highlightFont'] = new FontOptions();
