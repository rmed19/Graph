...
namespace Ezc\Graph\Options;
/**
 * File containing the Renderer2dOptions class
 *
 ...
 * classes are:
 *
 * - Ezc\Graph\Options\LineChartOptions
 * - Ezc\Graph\Options\PieChartOptions
 * - Ezc\Graph\Options\RadarChartOptions
 *
 ...
 *
 * - Ezc\Graph\Options\Renderer2dOptions
 * - Ezc\Graph\Options\Renderer3dOptions
 *
 ...
 * @package Graph
 */
class RendererOptions extends ChartOptions
{
    /**
     * Constructor
     * 
    ...
    public function __construct( array $options = array() )
    {
        ...
        $this->properties['pieChartSymbolColor'] = Color::fromHex( '#000000' );
        $this->properties['pieChartGleam'] = false;
        $this->properties['pieChartGleamColor'] = Color::fromHex( '#FFFFFF' );
        $this->properties['pieChartGleamBorder'] = 0;
        $this->properties['legendSymbolGleam'] = false;
        $this->properties['legendSymbolGleamSize'] = .9;
        $this->properties['legendSymbolGleamColor'] = Color::fromHex( '#FFFFFF' );
    ...
    public function __set( $propertyName, $propertyValue )
    {
        switch ( $propertyName )
        {
            ...
            case 'legendSymbolGleamColor':
                $this->properties[$propertyName] = Color::create( $propertyValue );
                break;
