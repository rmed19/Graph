...
/**
 * File containing the OdometerChartOptions class
 *
 ...
 *  
 *  $graph->data['Test'] = new \Ezc\Graph\Datasets\ArrayDataSet( array( 0, 1, 23, 30 ) );
 * 
 ...
 * @package Graph
 */
class OdometerChartOptions extends ChartOptions
{
    /**
     * Constructor
     *
    ...
    {
        $this->properties['borderColor']    = Color::create( '#000000' );
        $this->properties['borderWidth']    = 0;

        $this->properties['startColor']     = Color::create( '#4e9a06A0' );
        $this->properties['endColor']       = Color::create( '#A40000A0' );
