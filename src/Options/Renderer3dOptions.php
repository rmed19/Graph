...
/**
 * File containing the Renderer3dOptions class
 *
 ...
 * @package Graph
 */
class Renderer3dOptions extends RendererOptions
{
    /**
     * Constructor
     * 
    ...
    public function __construct( array $options = array() )
    {
        ...
        $this->properties['pieChartShadowColor'] = Color::fromHex( '#000000' );
    ...
    public function __set( $propertyName, $propertyValue )
    {
        switch ( $propertyName )
        {
            ...
            case 'pieChartShadowColor':
                $this->properties['pieChartShadowColor'] = Color::create( $propertyValue );
                break;
            default:
