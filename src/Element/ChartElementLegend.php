<?php
/**
 * File containing the abstract ChartElementLegend class
 *
 ...
 * @mainclass
 */
class ChartElementLegend extends AbstractChartElement
{
     ...
     *          'color' => (\Ezc\Graph\Colors\Color) $color,
     ...
     * 
     * @param ChartDataContainer $datasets 
     * @return void
     */
    public function generateFromDataSets( ChartDataContainer $datasets )
    {
        $this->labels = array();
     ...
     * @return void
     */
    public function generateFromDataSet( AbstractDataSet $dataset )
    {
        $this->labels = array();
     ...
     * 
     * @param Boundings $boundings Avalable boundings
     * @return Boundings Remaining boundings
     */
    protected function calculateBoundings( Boundings $boundings )
    {
