<?php
/**
 * File containing the AbstractDataSetAverage class
 *
 ...
 * @mainclass
 */
class AveragePolynom extends AbstractDataSet 
{
     ...
     * Constructor
     * 
     * @param AbstractDataSet $dataset Dataset to interpolate
     * @param int $order Maximum order of interpolating polynom
     * @return void
     * @ignore
     */
    public function __construct( AbstractDataSet $dataset, $order = 3 )
    {
        parent::__construct();
    ...
    protected function buildPolynom()
    {
        ...
        foreach ( $this->source as $key => $value )
        {
            ...
            $points[] = new Coordinate( (float) $key, (float) $value );
        }
