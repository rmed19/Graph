<?php
/**
 * File containing the abstract AxisProperty class
 *
 ...
 * validated as objects extending the AbstractChartElementAxis class.
 *
 ...
 * @package Graph
 */
class AxisProperty extends AbstractDataSetProperty
{
    /**
    ...
    protected function checkValue( &$value )
    {
       ...
       {
           throw new ezcBaseValueException( 'default', $value, 'AbstractChartElementAxis' );
       }
