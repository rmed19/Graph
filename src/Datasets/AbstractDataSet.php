<?php
/**
 * File containing the abstract AbstractDataSet class
 *
...
namespace Ezc\Graph\Datasets;

use Ezc\Graph\Datasets\Property\AxisProperty;
use Ezc\Graph\Datasets\Property\BooleanProperty;
use Ezc\Graph\Datasets\Property\ColorProperty;
use Ezc\Graph\Datasets\Property\IntProperty;
use Ezc\Graph\Datasets\Property\StringProperty;
 ...
 * @property \Ezc\Graph\Colors\Color $color
 ...
 * @property \Ezc\Graph\Element\AbstractChartElementAxis $xAxis
 *           Associate dataset with a different X axis then the default one
 * @property \Ezc\Graph\Element\AbstractChartElementAxis $yAxis
 ...
 * @mainclass
 */
abstract class AbstractDataSet implements \ArrayAccess, \Iterator, \Countable
{
    ...
    {
        $this->properties['label'] = new StringProperty( $this );
        $this->properties['color'] = new ColorProperty( $this );
        $this->properties['symbol'] = new IntProperty( $this );
        $this->properties['lineThickness'] = new IntProperty( $this );
        $this->properties['highlight'] = new BooleanProperty( $this );
        $this->properties['highlightValue'] = new StringProperty( $this );
        $this->properties['displayType'] = new IntProperty( $this );
        $this->properties['url'] = new StringProperty( $this );

        $this->properties['xAxis'] = new AxisProperty( $this );
        $this->properties['yAxis'] = new AxisProperty( $this );
