<?php
/**
 * File containing the Color class
 *
...
class Color extends Options
{
    ...
    /**
     * Creates an Color object from a hexadecimal color representation
     * 
    ...
    /**
     * Creates an Color object from an array of integers
     * 
    ...
    /**
     * Creates an Color object from an array of floats
     * 
    ...
    static public function create( $color )
    {
        ...
        elseif ( is_array( $color ) )
        {
            ...
            {
                return Color::fromIntegerArray( $color );
            } 
            else 
            {
                return Color::fromFloatArray( $color );
            }
        }
        else
        {
