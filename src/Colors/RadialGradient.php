<?php
/**
 * File containing the RadialGradient class
 *
 ...
 * gradients it falls back to a native Color. In this case the start
...
class RadialGradient extends Color
{
     ...
     * @return void
     */
    public function __construct( Coordinate $center, $width, $height, Color $startColor, Color $endColor )
    {
