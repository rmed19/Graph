...
/**
 * File containing the abstract AbstractAxisLabelRenderer class
 *
 ...
 * @package Graph
 */
abstract class AbstractAxisLabelRenderer extends Options
{
    /**
    ...
    public function __set( $propertyName, $propertyValue )
    {
        ...
        {
            case 'driver':
                if ( $propertyValue instanceof AbstractDriver )
                {
     ...
     * both as instances of {@link Coordinate}. If no cutting point
     ...
     * 
     * @param Coordinate $aStart 
     * @param Coordinate $aDir 
     * @param Coordinate $bStart 
     * @param Coordinate $bDir 
     * @return mixed
     */
    public function determineLineCuttingPoint( Coordinate $aStart, Coordinate $aDir, Coordinate $bStart, Coordinate $bDir )
    {
     ...
     * @param Coordinate $position Position of step
     * @param Coordinate $direction Direction of axis
     * @param int $axisPosition Position of axis
     * @param int $size Step size
     * @param Color $color Color of axis
     * @return void
     */
    public function drawStep( ezcGraphRenderer $renderer, Coordinate $position, Coordinate $direction, $axisPosition, $size, Color $color )
    {
     ...
     * @return void
     */
    protected function drawNonRectangularGrid( ezcGraphRenderer $renderer, ezcGraphBoundings $boundings, Coordinate $position, Coordinate $direction, Color $color )
    {
        // Direction of grid line is direction of axis turned right by 90 
        // degrees
        $gridDirection = new Coordinate(
            $direction->y,
            - $direction->x
        );
        ...
        foreach ( array( // Bounding lines
                array(
                    'start' => new Coordinate( $boundings->x0, $boundings->y0 ),
                    'dir' => new Coordinate( 0, $boundings->y1 - $boundings->y0 )
                ),
                array(
                    'start' => new Coordinate( $boundings->x0, $boundings->y0 ),
                    'dir' => new Coordinate( $boundings->x1 - $boundings->x0, 0 )
                ),
                array(
                    'start' => new Coordinate( $boundings->x1, $boundings->y1 ),
                    'dir' => new Coordinate( 0, $boundings->y0 - $boundings->y1 )
                ),
                array(
                    'start' => new Coordinate( $boundings->x1, $boundings->y1 ),
                    'dir' => new Coordinate( $boundings->x0 - $boundings->x1, 0 )
                ),
            ) as $boundingLine )
        {
     ...
     * @return void
     */
    protected function drawRectangularGrid( ezcGraphRenderer $renderer, ezcGraphBoundings $boundings, Coordinate $position, Coordinate $direction, Color $color )
    {
     ...
     * @return void
     */
    protected function drawGrid( ezcGraphRenderer $renderer, ezcGraphBoundings $boundings, Coordinate $position, Coordinate $direction, Color $color )
    {
     ...
     * @param Coordinate $direction Direction of the current axis
     * @return ezcGraphBoundings Modified boundings
     */
    public function modifyChartBoundings( ezcGraphBoundings $boundings, Coordinate $direction )
    {
        return $boundings;
    }
     ...
     * @return array
     */
    protected function getAxisSpace( ezcGraphRenderer $renderer, ezcGraphBoundings $boundings, AbstractChartElementAxis $axis, $innerBoundings, &$gridBoundings )
    {
