<?php
/**
 * File containing the abstract AbstractDriver class
 *
...
abstract class AbstractDriver
{
    ...
    public function __set( $propertyName, $propertyValue ) 
    {
        switch ( $propertyName ) {
            case 'options':
                if ( $propertyValue instanceof DriverOptions )
                {
     ...
     * array (
     *      'center' => (Coordinate) New center point,
     *      'start' => (Coordinate) New outer start point,
     *      'end' => (Coordinate) New outer end point,
     * )
     * 
     ...
     * @return array
     */
    protected function reduceEllipseSize( Coordinate $center, $width, $height, $startAngle, $endAngle, $size )
    {
     ...
     * @return void
     */
    abstract public function drawPolygon( array $points, Color $color, $filled = true, $thickness = 1. );
     ...
     * @return void
     */
    abstract public function drawLine( Coordinate $start, Coordinate $end, Color $color, $thickness = 1. );
     ...
     */
    abstract protected function getTextBoundings( $size, FontOptions $font, $text );
     ...
     * @param Coordinate $position Topleft position of the text box
     ...
     * @return void
     */
    protected function tryFitShortenedString( $string, Coordinate $position, $width, $height, $size )
    {
        $tokens = preg_split( '/\s+/', $string );
     ...
     * @return void
     */
    abstract public function drawTextBox( $string, Coordinate $position, $width, $height, $align, ezcGraphRotation $rotation = null );
     ...
     * @return void
     */
    abstract public function drawCircleSector( Coordinate $center, $width, $height, $startAngle, $endAngle, Color $color, $filled = true );
     ...
     * @return void
     */
    abstract public function drawCircularArc( Coordinate $center, $width, $height, $size, $startAngle, $endAngle, Color $color, $filled = true );
     ...
     * @return void
     */
    abstract public function drawCircle( Coordinate $center, $width, $height, Color $color, $filled = true );
     ...
     * @return void
     */
    abstract public function drawImage( $file, Coordinate $position, $width, $height );
