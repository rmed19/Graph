<?php
/**
 * File containing the abstract AbstractRenderer class
 *
...
abstract class AbstractRenderer
{
     ...
     * </code>
     *
     * @param AbstractDriver $driver Output driver
     * @return void
     */
     ...
     * 
     * @param Context $context Dataoint context
     * @param mixed $reference Driver dependant reference
     * @return void
     */
    protected function addElementReference( Context $context, $reference )
    {
     ...
     * array of Coordinate objects, which roughly describe the outline
     ...
     * @return void
     */
    protected function drawAxisArrowHead( Coordinate $position, ezcGraphVector $direction, $size, Color $color )
    {
     ...
     * @param Color $color Color of symbol
