<?php
/**
 * File containing the abstract AbstractChartElement class
 *
 ...
 *
 * - Chart title (AbstractChartElementText)
 * - Chart legend (AbstractChartElementLegend)
 * - The axis (Ezc\Graph\Axis\ChartElementNumericAxis,
 *   Ezc\Graph\Axis\ChartElementLogarithmicalAxis, Ezc\Graph\Axis\ChartElementLabeledAxis,
 *   ChartElementDateAxis)
 * - ...
 * 
 ...
 *  $graph->data['example'] = new \Ezc\Graph\Datasets\ArrayDataSet( array(
 *      'Foo' => 23,
 *      'Bar' => 42,
 *  ) );
 *  
 ...
 * @package Graph
 */
abstract class AbstractChartElement extends Options
{
    ...
    public function __construct( array $options = array() )
    {
        ...
        $this->properties['font'] = new FontOptions();
    ...
    public function __set( $propertyName, $propertyValue )
    {
        switch ( $propertyName )
        {
            case 'title':
                ...
                break;
            case 'background':
                $this->properties['background'] = Color::create( $propertyValue );
                break;
            case 'border':
                $this->properties['border'] = Color::create( $propertyValue );
                break;
            case 'padding':
            ...
            case 'borderWidth':
                ...
                break;
            case 'font':
                if ( $propertyValue instanceof FontOptions )
                {
                ...
                {
                    throw new ezcBaseValueException( $propertyName, $propertyValue, 'FontOptions' );
                }
                break;
            case 'position':
                $positions = array(
