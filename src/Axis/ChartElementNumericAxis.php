...
/**
 * File containing the abstract ChartElementNumericAxis class
 *
 ...
 *  $graph->legend = false;
 *  
 *  $graph->xAxis = new ChartElementNumericAxis();
 ...
 * @mainclass
 */
class ChartElementNumericAxis extends AbstractChartElementAxis
{
