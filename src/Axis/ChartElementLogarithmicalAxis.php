...
/**
 * File containing the ChartElementLogarithmicalAxis class
 *
 ...
 * chart elements (Ezc\Graph\Interfaces\AbstractChartElement) extending from
 * AbstractChartElementAxis, where additional formatting options can be found.
 ...
 *  $graph->yAxis = new ChartElementLogarithmicalAxis();
 *  
 *  $graph->data['x^2'] = new \Ezc\Graph\Datasets\NumericDataSet(
 *      -10, 10,
 *      create_function( '$x', 'return pow( $x, 2 ) + 1;' )
 *  );
 *  
 *  $graph->data['x^4'] = new \Ezc\Graph\Datasets\NumericDataSet(
 *      -10, 10,
 *      create_function( '$x', 'return pow( $x, 4 ) + 1;' )
 *  );
 *  
 *  $graph->data['x^6'] = new \Ezc\Graph\Datasets\NumericDataSet(
 *      -10, 10,
 ...
 * @mainclass
 */
class ChartElementLogarithmicalAxis extends AbstractChartElementAxis
{
