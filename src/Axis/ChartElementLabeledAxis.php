...
/**
 * File containing the ChartElementLabeledAxis class
 *
 ...
 * @mainclass
 */
class ChartElementLabeledAxis extends AbstractChartElementAxis
{
    /**
    ...
    public function __construct( array $options = array() )
    {
        ...
        $this->axisLabelRenderer = new AxisCenteredLabelRenderer();
