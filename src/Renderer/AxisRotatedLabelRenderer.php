 ...
 * @mainclass
 */
class AxisRotatedLabelRenderer extends AbstractAxisLabelRenderer
{
    /**
     ...
     * @return float
     */
    protected function determineTextOffset( AbstractChartElementAxis $axis, array $steps ) {
     ...
     * @return float
     */
    protected function calculateLabelLength( Coordinate $start, Coordinate $end, $xSpace, $ySpace, ezcGraphBoundings $axisBoundings )
    {
        $axisSpaceFactor = abs(
     ...
     * @return void
     */
    protected function renderLabelText( ezcGraphRenderer $renderer, AbstractChartElementAxis $axis, Coordinate $position, $label, $degTextAngle, $labelLength, $labelSize, $lengthReducement )
    {
        switch ( true )
        {
            case ( ( ( $degTextAngle >= 0 ) && 
