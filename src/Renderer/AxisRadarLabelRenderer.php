<?php
/**
 * File containing the AxisRadarLabelRenderer class
 *
 ...
 *
 * <code>
 *   $chart->xAxis->axisLabelRenderer = new AxisRadarLabelRenderer();
 * </code>
 *
 ...
 * @mainclass
 */
class AxisRadarLabelRenderer extends AbstractAxisLabelRenderer
{
    /**
     * Constructor
     * 
     ...
     * @return void
     */
    protected function drawGrid( ezcGraphRenderer $renderer, ezcGraphBoundings $boundings, Coordinate $position, Coordinate $direction, Color $color, $stepPosition = null )
    {
