...
class Renderer2d 
    extends
        ezcGraphRenderer
    implements
        ezcGraphRadarRenderer, StackedBarsRendererInterface, ezcGraphOdometerRenderer
{
    ...
    {
        $this->options = new Renderer2dOptions( $options );
    }
     ...
     * @param Coordinate $position 
     * @param ezcGraphBoundings $boundings 
     * @param AbstractChartElementAxis $axis 
     * @return void
     */
    protected function drawAxisLabel( Coordinate $position, ezcGraphBoundings $boundings, AbstractChartElementAxis $axis )
    {
        if ( $axis->label === false )
        {
            return;
        ...
        switch ( $axis->position )
        {
            case ezcGraph::TOP:
                $this->driver->drawTextBox(
                    ...
                    new ezcGraphRotation( $axis->labelRotation, new Coordinate(
     ...
     * @param ezcGraphBoundings $boundings 
     * @param AbstractChartElementAxis $axis
     * @param OdometerChartOptions $options
     * @return ezcGraphBoundings
     */
    public function drawOdometer( 
        ezcGraphBoundings $boundings, 
        AbstractChartElementAxis $axis,
        OdometerChartOptions $options )
    {
