...
use Ezc\Graph\DataContainer\ChartSingleDataContainer;
...
/**
 * File containing the OdometerChart class
 *
 ...
 * {@link Ezc\Graph\Options\OdometerChartOptions} extending the {@link
 * \Ezc\Graph\Options\ChartOptions}.
 *
 * @property OdometerChartOptions $options
 *           Chart options class
 *
 * @version //autogentag//
 * @package Graph
 * @mainclass
 */
class OdometerChart extends ezcGraphChart
{
    ...
    {
        $this->options = new OdometerChartOptions( $options );

        parent::__construct( $options );

        $this->data = new ChartSingleDataContainer( $this );

        $this->addElement( 'axis', new ChartElementNumericAxis());
        $this->elements['axis']->axisLabelRenderer = new AxisCenteredLabelRenderer();
