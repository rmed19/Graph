...
use Ezc\Graph\Renderer\HorizontalRenderer;
use Ezc\Graph\Structs\Coordinate;

/**
 * File containing the HorizontalBarChart class
 *
 ...
 *  $chart->renderer = new \Ezc\Graph\Renderer\HorizontalRenderer();
 ...
 *  - xAxis ( {@link ChartElementLabeledAxis} )
 *  - yAxis ( {@link ChartElementNumericAxis} )
 *
...
class HorizontalBarChart extends BarChart
{
    ...
    public function __construct( array $options = array() )
    {
        ...
        $this->addElement( 'xAxis', new ChartElementNumericAxis() );
        $this->elements['xAxis']->axisLabelRenderer = new AxisCenteredLabelRenderer();
        $this->elements['xAxis']->position = ezcGraph::LEFT;

        $this->addElement( 'yAxis', new ChartElementLabeledAxis() );
        $this->elements['yAxis']->axisLabelRenderer = new AxisBoxedLabelRenderer();
        $this->elements['yAxis']->position = ezcGraph::BOTTOM;

        $this->renderer = new HorizontalRenderer();
    }
     ...
     *
     * This function is nearly the same as in  \Ezc\Graph\Charts\LineChart, but reverses
