 ...
 * {@link \Ezc\Graph\Options\LineChartOptions} extending the {@link \Ezc\Graph\Options\ChartOptions}.
 *
 * @property LineChartOptions $options
 *           Chart options class
 *
 * @version //autogentag//
 * @package Graph
 * @mainclass
 */
class LineChart extends ezcGraphChart
{
    /**
    ...
    {
        $this->additionalAxis = new AxisContainer( $this );
        ...
        $this->addElement( 'xAxis', new ChartElementLabeledAxis() );
        $this->elements['xAxis']->position = ezcGraph::LEFT;

        $this->addElement( 'yAxis', new ChartElementNumericAxis() );
     ...
     * @return void
     */
    protected function calculateStepWidth( AbstractChartElementAxis $mainAxis, AbstractChartElementAxis $secondAxis, $width )
    {
     ...
     * @return void
     */
    protected function renderData( ezcGraphRenderer $renderer, Boundings $boundings, Boundings $innerBoundings )
    {
    ...
    protected function checkRenderer()
    {
        ...
        {
            if ( !$this->renderer instanceof StackedBarsRendererInterface )
            {
                throw new ezcBaseValueException( 'renderer', $this->renderer, 'StackedBarsRendererInterface' );
            }
        }
    }
    ...
    protected function renderElements( $width, $height )
    {
        ...
        foreach ( $this->additionalAxis as $element )
        {
            ...
            else
            {
                ...
                $element->axisLabelRenderer = new AxisNoLabelRenderer();
            }
