...
/**
 * File containing the PieChart class
 *
 ...
 * {@link Ezc\Graph\Options\PieChartOptions} extending the {@link \Ezc\Graph\Options\ChartOptions}.
 *
 * @property PieChartOptions $options
 *           Chart options class
 *
 * @version //autogentag//
 * @package Graph
 * @mainclass
 */
class PieChart extends ezcGraphChart
{
    ...
    {
        $this->options = new PieChartOptions( $options );
            ...
            switch ( $dataset->displayType->default )
            {
                case ezcGraph::PIE:
                    ...
                    $renderer->drawPieSegment(
                        $boundings,
                        new Context( $datasetName, $label, $dataset->url[$label] ),
                        $dataset->color[$label],
                        $angle,
                        $angle += $value / $sum * 360,
                        $displayLabel,
