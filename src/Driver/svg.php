 ...
 * {@link SvgDriverOptions} extending the basic driver options class
 ...
 *   $graph->driver->options->graphOffset = new Coordinate( 25, 40 );
 ...
 * @mainclass
 */
class ezcGraphSvgDriver extends AbstractDriver
{
    ...
    public function drawCircularArc( Coordinate $center, $width, $height, $size, $startAngle, $endAngle, Color $color, $filled = true )
    {
             ...
             $filled )
        {
            $gradient = new LinearGradient(
                ...
                Color::fromHex( '#000000' )->transparent( $this->options->shadeCircularArc )
            );
